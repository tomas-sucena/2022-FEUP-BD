...
-- Jogadores
    ...
    VALUES (1, "Rashard Odomes", 1996-12-21, "Masculino", 198, 98, "Portugal", 1, "Base");

    INSERT INTO Jogador (idEquipa, nome, dataNascimento, sexo, altura, peso, nacionalidade, numCamisola, posicao)
    VALUES (1, "Bradley Tinsley", 1989-05-10, "Masculino", 191, 93, "Estados Unidos da América", 5, "Base");

    INSERT INTO Jogador (idEquipa, nome, dataNascimento, sexo, altura, peso, nacionalidade, numCamisola, posicao)
    VALUES (1, "Francisco Amarante", 2000-03-24, "Masculino", 194, 95, "Portugal", 6, Base/Extremo);

    INSERT INTO Jogador (idEquipa, nome, dataNascimento, sexo, altura, nacionalidade, numCamisola, posicao)
    VALUES (1, "Max Landis", 1993-02-02, "Masculino", 188, 84, "Estados Unidos da América", 10, "Base/Extremo");

    INSERT INTO Jogador (idEquipa, nome, dataNascimento, sexo, altura, peso, nacionalidade, numCamisola, posicao)
    VALUES (1, "Charlon Kloof", 1990-03-20, "Masculino", 188, 88, "Países Baixos", 90, "Base");

    INSERT INTO Jogador (idEquipa, nome, dataNascimento, sexo, altura, peso, nacionalidade, numCamisola, posicao)
    VALUES (1, "Miguel Correia", 2000-09-29, "Masculino", 188, 74, "Portugal", 44, "Base");

    INSERT INTO Jogador (idEquipa, nome, dataNascimento, sexo, altura, peso, nacionalidade, numCamisola, posicao)
    VALUES (1, "Vladyslav Voytso", 1999-07-30, "Masculino", 200, 91, "Portugal", 3, "Extremo");

    INSERT INTO Jogador (idEquipa, nome, dataNascimento, sexo, altura, peso, nacionalidade, numCamisola, posicao)
    VALUES (1, "Tiago Almeida", 2003-06-12, "Masculino", 190, 88, "Portugal", 12, "Base/Extremo");

    INSERT INTO Jogador (idEquipa, nome, dataNascimento, sexo, altura, peso, nacionalidade, numCamisola, posicao)
    VALUES (1, "João Maia", 1990-03-27, "Masculino", 200, 97, "Portugal", 17, "Extremo");

    INSERT INTO Jogador (idEquipa, nome, dataNascimento, sexo, altura, peso, nacionalidade, numCamisola, posicao)
    VALUES (1, "Luís Silva", 2004-04-29, "Masculino", 193, 85, "Portugal", 7, "Extremo");

    INSERT INTO Jogador (idEquipa, nome, dataNascimento, sexo, altura, peso, nacionalidade, numCamisola, posicao)
    VALUES (1, "João Torrie", 1991-03-20, "Masculino", 200, 88, "Portugal", 2, "Poste");

    INSERT INTO Jogador (idEquipa, nome, dataNascimento, sexo, altura, peso, nacionalidade, numCamisola, posicao)
    VALUES (1, "Jonathan Arledge", 1991-09-21, "Masculino", 205, 105, "Estados Unidos da América", 21, "Poste/Extremo");

    INSERT INTO Jogador (idEquipa, nome, dataNascimento, sexo, altura, peso, nacionalidade, numCamisola, posicao)
    VALUES (1, "Miguel Queiroz", 1991-07-04, "Masculino", 204, 99, "Portugal", 11, "Extremo/Poste");

    INSERT INTO Jogador (idEquipa, nome, dataNascimento, sexo, altura, peso, nacionalidade, numCamisola, posicao)
    VALUES (1, "Markus Loncar", 1996-04-08, "Masculino", 213, 104, "Croácia", 7, "Poste");
